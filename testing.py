...
data = pd.read_csv("/Users/da-m1-09/Documents/GazaLMS/pages/Lib.csv")
hide_pages(["DisplayBooksCart"])
hide_pages(["testing"])


id = st.button("Back to Library...")
if id:
    switch_page("DisplayBooksCart")
...
with col2:
    ...
    with col2:
        st.markdown(genres)
        pay = st.button("Check Out To Lend A Book")
        if pay:
            switch_page("Payment")
